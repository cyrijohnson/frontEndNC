...
function continueToContact() {
    ...
    $.ajax({
        url: 'http://127.0.0.1:5000/addService?userid=' + user + '&tok=' + tok,
        type: 'POST',
...
function nextToSchedule() {
    ...
    $.ajax({
        url: 'http://127.0.0.1:5000/addServiceContact?userid=' + user + '&tok=' + tok,
        type: 'POST',
...
function nextToKeywords() {
    ...
    $.ajax({
        url: 'http://127.0.0.1:5000/addServiceSchedule?userid=' + user + '&tok=' + tok,
        type: 'POST',
...
function submitReistration() {
    ...
    $.ajax({
        url: 'http://127.0.0.1:5000/addServiceKeywords?userid=' + user + '&tok=' + tok,
        type: 'POST',
...
function uploadImage(){
    $.ajax({
        type:'POST',
        url: 'http://127.0.0.1:5000/saveServiceImage?sid='+serviceid,
        data:formData,
        cache:false,
        contentType: false,
        processData: false,
